...
\begin{abstract}
The source of auroral X-ray emission from the Jovian polar caps, whether from electron bremmstrahlung or heavy ion precipitation, has been veiled in mystery and debate for the past 40 years, beginning with the Einstein Observatory first measurement of X-rays in 1979.
...
Whereas heavy ion precipitation has been able to reproduce strong X-ray fluxes, but the proposed ion energy seemed to likely be much higher ($>$1 MeV/nucleon) than what is present above Jupiter.
Now with National Aeronautics and Space Administration's Juno spacecraft arriving at Jupiter, there have been many measurements of heavy ion populations above the polar cap with energies up to 300-400 keV/nucleon (keV/u), well below predictions of previous models.
Meanwhile, \citet{schultz2018} have provided a new outlook on how ion-neutral collisions in the Jovian atmosphere are occurring, providing us with an entirely new set of impact cross-sections and a total of 35 collision processes.
...
We are able to output predicted X-ray fluxes, efficiencies, and spectra for various initial ion energies considering opacity effects from two different atmospheres, with the goal of making this data available for quick X-ray calculations given an input ion flux.
A quick calculation is given showing that an \textit{in situ} measured heavy ion flux above Jupiter's polar cap is capable of producing over 1 GW of X-ray emission.
\end{abstract}
