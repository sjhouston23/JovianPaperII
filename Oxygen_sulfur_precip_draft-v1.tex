...
The total X-ray production shown in Table \ref{tab:JEDIFlux} is only a few percent different than what is shown in Figure \ref{fig:JEDISpec}.
The exact same process can be used for sulfur.
