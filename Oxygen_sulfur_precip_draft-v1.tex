...
Electron bremmstrahlung modeling has fallen short of producing the total overall power output being observed by our earth-orbit-based X-ray observatories and observations suggest that it may contribute $\sim$10$\%$ of the total emission.
...
Now with the National Aeronautics and Space Administration's Juno spacecraft arriving at Jupiter, there have been many measurements of heavy ion populations above the polar cap with energies up to 300-400 keV/nucleon (keV/u), well below predictions from previous models.
