...
\begin{figure}[ht]
    ...
    \caption{The O$^{6+}$ production rate from TI, SC, and SC+SS vs. H$_2$ density and altitude for various incident ion energies (E=0.2, 0.3, 0.5, 1.0, 2.0, 5.0, 10.0, and 25.0 MeV/u).}
    \label{fig:O6+Prod}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{The O$^{7+}$ production rate from TI, SC, and SC+SS vs. H$_2$ density and altitude for various incident ion energies (E=0.3, 0.5, 1.0, 2.0, 5.0, 10.0, and 25.0 MeV/u).}
    \label{fig:O7+Prod}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{The S$^{7+}$ production rate from TI, SC, and SC+SS vs. H$_2$ density and altitude for various incident ion energies (E=0.2, 0.3, 0.5, 1.0, and 2.0 MeV/u).}
    \label{fig:S7+Prod}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{The S$^{8+}$ production rate from TI, SC, and SC+SS vs. H$_2$ density and altitude for various incident ion energies (E=0.2, 0.3, 0.5, 1.0, and 2.0 MeV/u).}
    \label{fig:S8+Prod}
\end{figure}
