...
\citet{hui2010} created synthetic, charge exchange, X-ray spectra for O$^{6+}$, O$^{7+}$, and S$^{8+}$-S$^{14+}$ that we have integrated into our model.
...
\begin{table}[ht]
    ...
    Energy  & \multicolumn{4}{c|}{0$^\circ$} & \multicolumn{4}{c}{90$^\circ$} \\ \cline{2-9}
    $\mathrm{[keV/u]}$ & O$^{6+}$ & O$^{7+}$ & S$^{8+}$ & S$^{9+}$ & O$^{6+}$ & O$^{7+}$ & S$^{8+}$ & S$^{9+}$ \\ \cline{1-9}
    200      & 0.0140 & 0.0005 & 0.0023 & 0.0001 & 0.0137 & 0.0005 & 0.0021 & 0.0001 \\
    300      & 0.1192 & 0.0106 & 0.0506 & 0.0084 & 0.1131 & 0.0105 & 0.0436 & 0.0078 \\
    500      & 0.2653 & 0.0733 & 0.3120 & 0.1851 & 0.2284 & 0.0702 & 0.2332 & 0.1544 \\
    1000     & 0.2080 & 0.1904 & 0.1526 & 0.1217 & 0.1310 & 0.1446 & 0.1178 & 0.0915 \\
    2000     & 0.0942 & 0.1234 & 0.0497 & 0.0453 & 0.0603 & 0.0781 & 0.0583 & 0.0450 \\
    \hline
    \end{tabular}
